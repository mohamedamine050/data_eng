...
def get_args() -> dict:
    ...
    try:
        ...
        # Évite le MagicMock dans CI/tests
        if isinstance(args, dict) and isinstance(args.get("CONFIG_PATH"), str):
            return args

    except Exception:
        pass

    # Fallback local/tests
    ...
    raise ValueError("CONFIG_PATH argument missing")
